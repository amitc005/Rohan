...
public class QuotationhistoryServlet extends HttpServlet {
    ...
    private void deleteRequest(HttpServletRequest request, HttpServletResponse response) {
        ...
        try {
            ...
            QuotationhistoryService.deleteTblQuotationhistory(QuotationhistoryService.getTblQuotationHistoryById(id));
            response.sendRedirect(IServletConstant.PAGE_VIEW_QUOTATION);
    ...
    private TblQuotationhistory doMapping(HttpServletRequest request, HttpServletResponse response) {
      ...
      private void search(HttpServletRequest request, HttpServletResponse response) {
        try {
            ...
            List<TblQuotationhistory> searchQuotationhistory = QuotationhistoryService.searchQuotationhistory(hashMap);
            
            request.getSession().setAttribute("accountsearch", searchQuotationhistory);
            
            response.sendRedirect(IServletConstant.PAGE_VIEW_ORDERHISTORY);
        } catch (IOException ex) {
            Logger.getLogger(QuotationhistoryServlet.class.getName()).log(Level.SEVERE, null, ex);
        }
    }
}
