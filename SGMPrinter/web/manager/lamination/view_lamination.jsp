...
<a href="../<%= IServletConstant.PAGE_ADD_LAMINATION%>" style="padding-left: 20px;">
    <button type="submit" class="btn btn-success">ADD LAMINATION</button>
</a>
            ...
            <div class="widget-box">
                ...
                <div class="widget-content nopadding">
                    <table class="table table-bordered table-striped">
                        ...
                        <tbody>
                            <c:forEach var="lamination" items="${pageScope.tblLaminations}"> 
                                <tr>
