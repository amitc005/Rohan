...
<ul>
    <li class="active"><a href="index.jsp?requestPage="><i class="icon icon-home"></i> <span>Dashboard</span></a> </li>

    <li class="submenu"> <a href="index.jsp?requestPage=view_account"><i class="icon icon-th-list"></i> <span>Account</span></a>
        <ul>
            <li><a href="index.jsp?requestPage=add_account">Add account</a></li>
            <li><a href="index.jsp?requestPage=view_account">View account</a></li>
        </ul>
    </li>
